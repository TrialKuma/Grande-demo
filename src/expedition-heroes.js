...
export const NEW_HEROES=[
 {id:'youmu',name:'游木 / 游墓',short:'游木',role:'外科医生 · 沉渊船长',tag:'气息 · 手术 · 双人格',color:'#8dd4b4',maxHp:165,maxResource:10,resourceName:'气息',passiveName:'医者与船长',passiveDesc:'游木用手术准备、切除与标本移植治疗同伴、拆解敌人。血誓让游墓接管身体，暂时换成船长技能；急救处理眼前伤势，缝合提供持续恢复。',quote:'先别动，我能处理。',bio:'游木是认真而热血的年轻医生；寄宿其中的游墓博学、痴迷标本。救人的手术与船长的冒险共用一具身体。'},
...
export const NEW_SKILLS={
 youmu:[
  {id:'scalpel',name:'手术刀',sub:'SCALPEL',ap:1,kind:'physical',damage:30,hits:1,stagger:8,gain:1,surgicalSetup:true,icon:'blade',style:'slash',desc:'25 基础物理伤害、削韧 8，回复 1 气息；开启切除手术。',hint:'外科准备 · 回复气息'},
  ...
  {id:'bloodoath',name:'血誓 · 请船长上场',sub:'BLOOD OATH',ap:1,cost:2,transform:true,shield:24,selfShield:true,icon:'crystal',style:'guard',desc:'消耗 2 气息，主动献血使自身生命降至 40%；已经不高于 40% 时不再扣血。游墓接管并嘲讽两轮：单体主招优先攻击自己，船长架势提供力量 +5、智力 −5、敏捷 +9、意志 +2，获得 24 护盾并切换为船长技能。每场一次；退出后虚脱两轮，力量、智力、敏捷各降低 4。',hint:'主动献血 · 嘲讽 · 双形态'},
  {id:'sterilize',name:'清创整备',sub:'STERILIZE',ap:1,gain:4,heal:18,self:true,once:true,fieldCare:35,icon:'wind',style:'guard',desc:'回复4气息与自身18生命，准备切除并令选中敌人两轮内意志降低 5。本轮第一次受伤后，若仍存活，自动包扎回复35生命。每轮一次，包扎不能阻止致死伤害。',hint:'回复气息 · 外科整备'},
...
export const CAPTAIN_SKILLS={
 ...
 surgery:{name:'船长威严',kind:'magic',damage:28,hits:1,stagger:12,ap:1,cost:3,surgery:false,dotDamage:0,weaken:true,icon:'rune',style:'rune',desc:'消耗 3 气息，28 魔法伤害、削韧 12；敌人下一次行动前的力量、智力各降低 8，意志降低 4。'},
 ...
 sterilize:{name:'死海整帆',ap:1,cost:0,gain:3,heal:0,shield:0,selfShield:false,fieldCare:0,protection:0,selfProtection:false,selfAttackBuff:30,once:true,icon:'shield',style:'guard',desc:'回复3气息，下一次主动攻击获得力量、智力各 +10，两轮内使用有效。每轮一次。'},
