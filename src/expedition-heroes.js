...
export const CAPTAIN_SKILLS={
 ...
 firstaid:{name:'枪弹盛宴',kind:'physical',damage:29,hits:3,stagger:28,ap:2,cost:4,heal:0,allHeal:0,cleanse:0,revive:0,targetCleanse:0,icon:'scatter',style:'shot',desc:'消耗 4 气息，3 × 29 物理伤害、削韧 28。'},
