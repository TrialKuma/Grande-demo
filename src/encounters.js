export const BOSSES = {
  ...
  scout: {id:'scout',name:'巡路残机',subtitle:'STRAY SCOUT',region:'博洛伦 · 遗迹外沿',scene:'ruins',isTutorial:true,brief:'废弃的小型巡逻机，只会挥臂和提前亮灯的冲撞。先试着分配行动点，再用角色技能保护自己。',mechanic:'基础行动 · 两招交替',color:'#c0b08a',icon:'crosshair',hpMultiplier:.25},
  bulwark: {id:'bulwark',name:'松动石卫',subtitle:'CRACKED BULWARK',region:'博洛伦 · 石阶哨站',scene:'ruins',isTutorial:true,brief:'躯壳松动的旧石卫，挥拳之后会重踏地面。用新同伴的资源循环和防护技能合作通过。',mechanic:'资源循环 · 轮流行动',color:'#a9cbd3',icon:'shield',hpMultiplier:.4},
  conduit: {id:'conduit',name:'失控导流器',subtitle:'FAULTY CONDUIT',region:'博洛伦 · 引流前室',scene:'foundry',isTutorial:true,brief:'它用短促电击驱赶靠近的人，随后把积蓄的电流释放到整个房间。让三名队员分工，集中削韧或提前保护。',mechanic:'群体预告 · 三人协作',color:'#a5cddc',icon:'rune',hpMultiplier:.62},
