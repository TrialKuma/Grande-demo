...
export const HEROES = [
  ...
  {id:'haart',name:'哈特蒙斯',short:'哈特',role:'心灵操纵师',tag:'魔力 · 协同 · 保护',color:'#afa2eb',maxHp:150,maxResource:10,resourceName:'魔力',passiveName:'心智通路',passiveDesc:'魔力初始 10。付费技能须先支付足额魔力，成功后返还 2；免费基础攻击回复 1，收拢心神每轮可回复 4。魔力不会随回合自动恢复。成长奖励可让同伴的行动强化安抚、护盾强化书页。',quote:'行了，别催。我在看。',bio:'博洛伦特纳的院长，嫌麻烦，却总在奇怪的地方出现。用书本建立队友间的心智通路，安排攻击、安抚与保护。'},
  {id:'qianxing',name:'潜行',short:'潜行',role:'升格机械师',tag:'魔力 · 双系 · 战甲',color:'#88d2e6',maxHp:195,maxResource:10,resourceName:'魔力',passiveName:'升格模组',passiveDesc:'魔力初始 10。付费技能须先支付足额魔力，成功后返还 2；钉刺射击回复 1，紧急修复每轮可回复 4。钉刺护甲受物理攻击后回击；成长奖励可强化带盾光束与协同护甲。',quote:'先把人带出去，样本可以回来再取。',bio:'接受登天试炼、来到格朗德的探索者。沉着寡言，对未知事物十分执着；以战甲钉刺、银焱光束和修复装置完成任务。'}
];
export const SKILLS = {
  knibbs:[
  ...
  apeilia:[
    ...
    {id:'eden',name:'「伊甸之约」',sub:'EDEN PACT',ap:2,cost:4,kind:'physical',damage:25,hits:4,stagger:32,icon:'blades',style:'slash',desc:'消耗 4 连击，4 × 25 物理伤害、削韧 32。接魔法之后伤害 +25%、削韧 +6，并返还 1 连击。',hint:'物理爆发 · 削韧 · 交替返还连击'},
    {id:'sentinel',name:'「地狱哨兵」',sub:'HELL SENTINEL',ap:2,cost:4,kind:'magic',damage:104,hits:1,stagger:22,pierce:true,icon:'scope',style:'burst',desc:'消耗 4 连击，104 魔法伤害、削韧 22，无视魔法抗性。接物理之后强化并返还 1 连击。',hint:'魔法爆发 · 穿透抗性 · 交替返还连击'},
  ...
  haart:[
    {id:'page',name:'书页投射',sub:'PROJECTED PAGE',ap:1,kind:'magic',damage:30,hits:1,stagger:8,gain:1,icon:'rune',style:'rune',desc:'30 魔法伤害、削韧 8，回复 1 魔力。',hint:'基础魔法 · 回复魔力'},
    {id:'relay',name:'通路回响',sub:'LINKED ECHO',ap:2,cost:6,kind:'magic',damage:31,hits:3,stagger:24,icon:'twin',style:'rune',desc:'先支付 6 魔力，3 × 31 魔法伤害、削韧 24，施放成功后返还 2 魔力。',hint:'三段魔法 · 拆除防护层'},
    {id:'soothe',name:'心智安抚',sub:'CALMING LINK',ap:2,cost:5,heal:42,allHeal:12,cleanse:1,icon:'heal',style:'rune',desc:'先支付 5 魔力。最低生命比例队员回复 42，其他人回复 12，净化全队 1 层共鸣；施放成功后返还 2 魔力。',hint:'群体救治 · 清除共鸣'},
    {id:'rest',name:'收拢心神',sub:'RECOLLECT',ap:1,gain:4,heal:16,self:true,once:true,icon:'wind',style:'guard',desc:'不消耗魔力，回复 4 魔力与自身 16 生命，每轮一次。魔力没有自动回合回复。',hint:'魔力整备 · 自我恢复 · 每轮一次'},
    {id:'network',name:'心智协同',sub:'COORDINATED MIND',ap:2,cost:6,shield:28,cleanse:1,unlockKey:'haart_network',icon:'shield',style:'guard',desc:'先支付 6 魔力。通过队友间的心智通路统一防守，全队获得 28 护盾并净化 1 层共鸣，成功后返还 2 魔力。',hint:'全队防护 · 净化共鸣'}
  ],
  qianxing:[
    {id:'spike',name:'钉刺射击',sub:'METAL SPIKE',ap:1,kind:'physical',damage:32,hits:1,stagger:10,gain:1,icon:'crosshair',style:'shot',desc:'32 物理伤害、削韧 10，回复 1 魔力。',hint:'基础物理 · 回复魔力'},
    {id:'beam',name:'聚焦光束',sub:'FOCUSED BEAM',ap:2,cost:6,kind:'magic',damage:88,hits:1,stagger:32,icon:'scope',style:'burst',desc:'先支付 6 魔力，88 魔法伤害、削韧 32，施放成功后返还 2 魔力。',hint:'银焱光束 · 高削韧'},
    {id:'armor',name:'钉刺护甲',sub:'SPIKED ARMOR',ap:2,cost:5,shield:36,selfShield:true,reflect:1,icon:'shield',style:'guard',desc:'先支付 5 魔力，自身获得 36 护盾与 1 次钉刺反击。受到物理攻击后回击 28 物理伤害，最多储存 2 次；成功施放后返还 2 魔力。',hint:'自身护盾 · 物理受击反击'},
    {id:'repair',name:'紧急修复',sub:'FIELD REPAIR',ap:1,gain:4,heal:26,self:true,once:true,icon:'wind',style:'guard',desc:'不消耗魔力，回复 4 魔力与自身 26 生命，每轮一次。魔力不会随回合自动恢复。',hint:'魔力整备 · 自我修复 · 每轮一次'},
    {id:'nova',name:'灭绝耀光',sub:'ANNIHILATING LIGHT',ap:2,cost:8,kind:'magic',damage:40,hits:3,stagger:34,pierce:true,unlockKey:'qianxing_nova',icon:'scatter',style:'burst',desc:'先支付 8 魔力，3 × 40 魔法伤害、削韧 34，无视魔法抗性；施放成功后返还 2 魔力。',hint:'银焱爆发 · 穿透抗性 · 高魔力投入'}
  ]
};
...
SKILLS.ric=[
 ...
 {id:'mend',name:'负域 · 缚足同化',sub:'BINDING DOMAIN',ap:2,heal:36,allHeal:10,shift:-4,cleanse:2,weaken:true,icon:'bind',style:'rune',desc:'敌人下一次行动全部伤害降低 20%，枪式获得强化；最低生命比例队员回复 36，其余人 10，净化 2 层共鸣，平衡 −4。',hint:'削弱敌人 · 枪战准备 · 平衡 −4'},
...
SKILLS.haart.push({id:'anchor',name:'心念锚定',sub:'MENTAL ANCHOR',ap:1,cost:3,shield:16,selfShield:true,once:true,icon:'shield',style:'guard',desc:'先支付 3 魔力，自身获得 16 护盾，成功后返还 2 魔力；每轮一次。',hint:'低耗护念 · 自我保护'});
SKILLS.qianxing.push({id:'pulse',name:'脉冲射线',sub:'PULSE RAY',ap:1,cost:3,kind:'magic',damage:33,hits:1,stagger:8,icon:'scope',style:'shot',desc:'先支付 3 魔力，33 魔法伤害、削韧 8，成功后返还 2。',hint:'低耗魔法 · 双系衔接'});
...
export function createBattle(difficulty='standard',bossId='golem',options={}) {
  ...
  const partyIds=Array.isArray(requested)&&requested.length===3&&new Set(requested).size===3&&requested.every(id=>HEROES.some(h=>h.id===id))?requested:['knibbs','apeilia','ric'];
  const loadouts=normalizeLoadouts(upgrades,options.loadouts);
  const hp=Math.round(DIFFICULTIES[difficulty].hp*BOSSES[bossId].hpMultiplier);
  return {version:5,mode:'playing',difficulty,upgrades,loadouts,round:1,ap:6,maxAp:6,selected:partyIds[0],response:null,
    heroes:partyIds.map(id=>HEROES.find(h=>h.id===id)).map(h=>({...h,hp:h.maxHp,shield:0,resource:['knibbs','haart','qianxing','youmu','patch'].includes(h.id)?10:0,resonance:0,cooldowns:{},used:[],guard:false,intuition:0,lastKind:null,balanceBursts:0,grace:false,verdict:false,reflect:0,ricEdge:0,youmuForm:'doctor',surgicalReady:false,specimen:null,captainTurns:0,captainUsed:false,exhaustedTurns:0,exhaustionFresh:false,patchForm:'observe',records:0,recordProgress:0,patchRetaliation:false,patchObserved:false,patchRecorded:false})),
    boss:{id:bossId,hp,maxHp:hp,stage:0,core:false,corePhysical:0,coreMagic:0,coreTurns:2,coreFresh:false,reforms:0,stagger:160,maxStagger:160,broken:false,exposed:false,marked:false,weakened:0,fog:0,charging:false,phasePending:false,mirror:bossId==='duelist'?2:0,spores:bossId==='cantor'?1:0,controlImmune:0,charge:bossId==='warden'?2:0,seals:bossId==='weaver'?2:bossId==='final'?3:0,sealedKind:'physical',lastKind:null,sync:0,finale:false,finalePhysical:0,finaleMagic:0,finaleTurns:2,finaleFresh:false,intent:BOSS_INTENTS[bossId][0],intentTarget:partyIds[0]},
...
const manaRefund=(h,s)=>usesMana(h)&&s.cost>0?2:0;
const allyActed=(state,h)=>state.heroes.some(other=>other.id!==h.id&&other.used.length>0);
function resourceAfterSkill(h,s,alternating=false){
  return clamp(h.resource-(s.cost||0)+(s.gain||0)+(s.shift||0)+(alternating?1:0)+manaRefund(h,s)+(h.id==='patch'&&s.damage&&(s.patchStance||h.patchForm)==='observe'&&!h.patchObserved?1:0),h.id==='ric'?-10:0,h.maxResource);
}
export function canUse(state,id,skillId){
  ...
  if(s.transform&&(h.captainUsed||h.hp>h.maxHp*.4))return h.captainUsed?'本场已经请船长接管过':'生命不高于 40% 时才可请船长接管';
...
function canInterrupt(state){
  const b=state.boss;
  return !b.core&&!b.finale&&!b.broken&&!b.controlImmune&&(b.charging||(b.id==='duelist'&&['pierce','duel'].includes(b.intent))||(b.id==='cantor'&&['drain','bloom'].includes(b.intent))||(b.id==='warden'&&b.intent==='storm')||(b.id==='weaver'&&['silence','rewrite'].includes(b.intent))||(b.id==='final'&&b.intent==='zero_pulse'));
}
function breakBoss(state,events,label='架势击破'){
  ...
  b.stagger=0;b.broken=true;state.stats.breaks++;if(interrupted)state.stats.interrupts++;b.charging=false;
...
function coreCheck(state,events){
  const b=state.boss;
  if(b.core&&b.corePhysical>=3&&b.coreMagic>=3){state.mode='victory';events.push({type:'victory',actor:'boss',targets:['boss'],label:'核心净化'});log(state,'物理与魔法同时击穿核心。博洛伦的雾，散了。','good');}
}
function tunedSkill(state,h,s){
  const t={...s},notes=[],empowerNotes=[],owned=id=>(state.upgrades||[]).includes(id);
  if(h.id==='ric'){
  ...
  if(h.id==='youmu'){
    if(h.youmuForm==='captain'){Object.assign(t,CAPTAIN_SKILLS[s.id]||{}, {variant:'captain'});empowerNotes.push(`游墓接管：${t.name}`);}
      ...
      if(h.specimen){Object.assign(t,{name:'移植手术',damage:0,kind:undefined,stagger:0,cost:2,heal:30,allHeal:10,shield:18,selfShield:false,surgery:false,transplant:true,icon:'heal',style:'rune',variant:'transplant',desc:`将${SPECIMEN_NAMES[h.specimen]}标本转化为全队 18 护盾，主目标回复 30、其他人 10；标本随后消耗。`});empowerNotes.push(`${SPECIMEN_NAMES[h.specimen]}标本已就绪：切除变为移植`);}
    ...
    if(owned('youmu_resolve')&&s.id==='bloodoath'&&t.transform){t.shield=36;t.desc='生命不高于 40% 时，每战可花 1 AP / 2 气息让游墓接管两轮，获得 36 护盾；承伤 −35%，退出后虚脱两轮。';}
  }
  if(h.id==='patch'){
    if(s.id==='chargedslash'&&h.records>=3){
      if(h.patchForm==='observe')Object.assign(t,{name:'充能斩 · 断光',kind:'magic',damage:25,hits:2,stagger:18,consumeRecords:3,variant:'daybreak',style:'slash',desc:'1 AP，先支付 2 魔力，2 × 25 魔法伤害、削韧 18。自动消费 3 记录，成功后返还 2 魔力，再按本次支付生成记录。'});
      else Object.assign(t,{name:'充能斩 · 镜反',kind:'magic',damage:42,hits:1,stagger:14,shield:18,selfShield:true,patchWard:true,consumeRecords:3,variant:'mirror',style:'rune',desc:'1 AP，先支付 2 魔力，42 魔法伤害、削韧 14，自身获得 18 护盾及一次破盾回击。自动消费 3 记录，成功后返还 2 魔力。'});
      empowerNotes.push(`已有 3 记录：${t.name}，自动消费 3 记录；仍支付 2 魔力 / 1 AP`);
    }
    if(s.id==='fragments'&&h.records>=3){const high=h.records>=6;Object.assign(t,{name:high?'时光断面':'时光裂片',damage:high?34:36,hits:high?3:2,stagger:high?32:26,consumeRecords:high?6:3,variant:high?'section':'splinter',desc:`2 AP，先支付 6 魔力，${high?'3 × 34':'2 × 36'} 魔法伤害、削韧 ${high?32:26}；自动消费 ${high?6:3} 记录，成功后返还 2 魔力。`});empowerNotes.push(`${h.records} 记录就绪：自动强化为${t.name}，仍支付 6 魔力 / 2 AP`);}
    if(s.id==='revelation'&&h.records>=6){Object.assign(t,{damage:49,stagger:44,consumeRecords:6,variant:'revelation',desc:'3 AP，先支付 8 魔力，3 × 49 魔法伤害、削韧 44；自动消费 6 记录，成功后返还 2 魔力。没有额外行动或跳过回合。'});empowerNotes.push('6 记录：启示强化为 3 × 49 魔法伤害、削韧 44');}
    if(owned('patch_precision')&&t.consumeRecords&&t.damage){t.stagger+=6;empowerNotes.push('精确计时：记录强化招式额外削韧 6');}
    if(owned('patch_archive')&&t.patchWard){t.shield+=8;empowerNotes.push('厚页书阵：护盾额外 +8');}
  }
  ...
  if(owned('haart_triage')&&s.id==='soothe'&&allyActed(state,h)){t.heal=58;t.allHeal=22;t.cleanse=2;empowerNotes.push('通路接续：本轮其他同伴已使用技能，主目标回复 58 / 其余 22 / 净化 2');}
  if(owned('haart_echo')&&s.id==='page'&&h.shield>0){t.damage=24;t.hits=2;t.stagger=16;empowerNotes.push('护念回响：护盾存在，2 × 24 魔法伤害 / 削韧 16');}
  if(owned('qianxing_reinforce')&&s.id==='armor'&&allyActed(state,h)){t.allShield=14;empowerNotes.push('协同装甲：本轮其他同伴已使用技能，额外为全队附加 14 护盾');}
  if(owned('qianxing_focus')&&s.id==='beam'&&h.shield>0){t.damage=118;t.stagger=44;empowerNotes.push('稳固聚焦：自身有护盾，118 魔法伤害 / 削韧 44');}
  ...
  return {skill:t,intuition,alternating,consumeGrace,consumeVerdict,notes,empowered:empowerNotes.length>0,empowerReason:empowerNotes.join('；')};
}
...
function damageFactor(b,s){
  ...
  return factor*((b.broken||b.exposed)?1.5:1)*(b.marked?1.15:1);
}
...
export function skillPreview(state,heroId,skillId){
  ...
  if(manaRefund(h,t))notes.push(`须先支付 ${t.cost} 魔力，施放成功后返还 2 魔力`);
  if(state.boss.core&&t.damage)notes.push(`核心：${t.kind==='physical'?'物理':'魔法'}命中 +${Math.min(3-(t.kind==='physical'?b.corePhysical:b.coreMagic),t.hits||1)}`);
  ...
  if(state.boss.id==='final'&&t.kind){
    if(state.boss.finale)notes.push(`终幕登记：${t.kind==='physical'?'物理':'魔法'}命中完成；还需另一系与战术应对`);
  ...
  if(t.weaken)notes.push('领域束缚：敌人下一次行动全部伤害 −20%，不叠加');
  ...
  return {damage,hits:t.damage?t.hits||1:0,stagger,resourceBefore:h.resource,resourceAfter,notes,empowered,empowerReason,ap:t.ap,cost:t.cost||0,refund:manaRefund(h,t),heal:t.heal||0,allHeal:t.allHeal||0,shield:t.shield||0,allShield:t.allShield||0,cleanse:t.cleanse||0,self:!!t.self,selfShield:!!t.selfShield,reflect:t.reflect||0,mark:!!t.mark,name:t.name,description:t.desc,desc:t.desc,icon:t.icon,style:t.style,kind:t.kind,variant:t.variant||null,variantReason:empowerReason,recordsBefore:h.records||0,recordsAfter:h.id==='patch'?Math.min(6,h.records-(t.consumeRecords||0)+Math.floor((h.recordProgress+(t.cost||0))/2)):0};
}
export function heroStatus(state,heroId){
  ...
  if(h.id==='haart')return `魔力 ${h.resource}/10 · 付费施放返 2 · ${allyActed(state,h)?'同伴已行动，可衔接协同':'先让同伴行动，再衔接安抚'}`;
  if(h.id==='qianxing')return `魔力 ${h.resource}/10 · 付费施放返 2 · ${h.reflect?`钉刺反击 ${h.reflect} 次`:'护甲抵挡物理攻击并回击'}`;
  ...
  if(h.id==='patch')return `${h.patchForm==='observe'?'观测':'收录'} · 记录 ${h.records}/6 · ${h.records>=3?'条件变招已就绪':'付费行动积累记录'}（仍支付魔力）`;
...
export function bossSummary(state){
  ...
  if(b.weakened)result.push({label:'领域束缚',value:'下一次行动全部伤害 −20% · 雷克枪式强化',tone:'good'});
  if(b.id==='golem'){
  ...
  if(b.id==='final'){
    if(b.finale)result.push({label:'终幕',value:`物理 ${b.finalePhysical}/1 · 魔法 ${b.finaleMagic}/1 · ${state.response?'应对已准备':'还需准备应对'}`,tone:'warning'},{label:'剩余',value:`${b.finaleTurns} 个完整回合 · 三条件完成后结束回合终结`,tone:'warning'});
...
function dealToBoss(state,skill,events,actor,{response=false}={}){
  ...
  for(let i=0;i<(skill.hits||1);i++){
    if(wasCore){if(skill.kind==='physical')b.corePhysical=Math.min(3,b.corePhysical+1);if(skill.kind==='magic')b.coreMagic=Math.min(3,b.coreMagic+1);}
    else if(wasFinale){if(skill.kind==='physical')b.finalePhysical=1;if(skill.kind==='magic')b.finaleMagic=1;}
    else{const n=Math.round(skill.damage*damageFactor(b,skill)),taken=Math.min(b.hp,n);b.hp-=taken;total+=taken;}
    shiftBossLayers(b,skill);
  }
  state.stats.damage+=total;
  events.push({type:'attack',actor,targets:['boss'],kind:skill.kind,style:skill.style,hits:skill.hits||1,amount:wasCore?0:total,amounts:{boss:wasCore?0:total},label:skill.name});
  if(wasCore){log(state,`${h.short} · ${skill.name}：核心 物理 ${b.corePhysical}/3，魔法 ${b.coreMagic}/3。`,'good');coreCheck(state,events);return;}
  if(wasFinale){log(state,`${h.short} · ${skill.name}：双系接入 物理 ${b.finalePhysical}/1，魔法 ${b.finaleMagic}/1；准备应对，守住最后放电后关闭核心。`,'good');return;}
  log(state,`${h.short} · ${skill.name}，造成 ${total} ${skill.kind==='magic'?'魔法':'物理'}伤害。`);
  if(b.hp<=0){
    if(b.id==='final'){
      b.finale=true;b.finaleFresh=true;b.finaleTurns=2;b.finalePhysical=0;b.finaleMagic=0;b.broken=false;b.exposed=false;b.charging=false;b.controlImmune=0;b.seals=0;
      events.push({type:'phase',actor:'boss',targets:['boss'],label:'停机过载'});
      log(state,'核心进入停机过载！接下来 2 个完整回合内，以物理与魔法各命中一次完成双系接入，再准备战术应对。守住最后放电即可停机；超时则核心恢复 22% 生命。','warning');return;
    }
    if(b.id!=='golem'){
      ...
      events.push({type:'victory',actor:'boss',targets:['boss'],label:endings[b.id][0]});
      log(state,`${bossName(state)}已被击败。${endings[b.id][1]}`,'good');return;
    }
    b.core=true;b.coreFresh=true;b.corePhysical=0;b.coreMagic=0;b.coreTurns=2;b.broken=false;b.exposed=false;b.charging=false;b.phasePending=false;b.fog=5;
    events.push({type:'core',actor:'boss',targets:['boss'],label:'核心暴露'});log(state,'躯壳崩解！在接下来的 2 个完整回合内，对核心造成 3 次物理与 3 次魔法命中。','warning');return;
  }
  const stage=b.id==='golem'?Math.min(4,Math.floor((1-b.hp/b.maxHp)*5)):(b.hp<=b.maxHp*.5?1:0);
  if(stage>b.stage){
    b.stage=stage;
    if(b.id==='golem'){
      b.phasePending=!b.broken;events.push({type:'phase',actor:'boss',targets:['boss'],label:'元素解体'});
      log(state,`第 ${stage} 次元素解体${b.broken?'；架势崩溃使其无法蓄力':'：地裂将在下一轮预告，届时先恢复完整行动点'}。`,'warning');
    }else{
      const phaseNames={duelist:'镜刃过载',cantor:'菌冠升华',warden:'雷脊熔断',weaver:'缄默复写',final:'归零重启'};
      const phaseText={duelist:'补充 1 镜片，之后每轮开始恢复 1 镜片；招式伤害提高 6。',cantor:'孢压 +2，之后孢雨播种 3 层；招式伤害提高 5。',warden:'蓄电 +2，之后每轮额外获得 1 蓄电；主招基础伤害提高 5。',weaver:'封页恢复至 3，主招基础伤害提高 5；封缄抽取资源提高至 2。',final:'归零屏障恢复至 3，同步归零；主招基础伤害提高 7。耗尽生命后还有终幕。'};
      ...
      events.push({type:'phase',actor:'boss',targets:['boss'],label:phaseNames[b.id]});
...
function harmony(state,h,before,events){
  ...
  if(before<0&&h.resource>=0){
    ...
    h.balanceBursts++;const targets=alive(state),amounts={};for(const p of targets){const n=Math.min(10,60-p.shield);p.shield+=n;amounts[p.id]=n;}
...
export function useSkill(state,id,skillId){
  ...
  h.resource=resourceAfterSkill(h,s,alternating);
  ...
  if(s.transform){h.youmuForm='captain';h.captainTurns=2;h.captainUsed=true;h.surgicalReady=false;log(state,'游墓接管：两轮船长技能已展开；结束后游木会虚脱两轮。','warning');}
  if(h.id==='patch'){
    if(s.patchStance)h.patchForm=s.patchStance;
    h.records=Math.max(0,h.records-(s.consumeRecords||0));
    const paid=h.recordProgress+(s.cost||0);h.records=Math.min(6,h.records+Math.floor(paid/2));h.recordProgress=paid%2;
    if(s.damage&&h.patchForm==='observe')h.patchObserved=true;
    if(s.patchWard)h.patchRetaliation=true;
  }
  if(manaRefund(h,s))log(state,`${h.short}先支付 ${s.cost} 魔力，施放成功后回流 2 魔力（${before} → ${h.resource}）。`);
  ...
  if(s.shield){
    const targets=s.selfShield?[h]:alive(state),amounts={};targets.forEach(p=>{amounts[p.id]=Math.min(s.shield,60-p.shield);p.shield+=amounts[p.id];p.resonance=Math.max(0,p.resonance-(s.cleanse||0));if(s.reflect)p.reflect=Math.min(2,(p.reflect||0)+s.reflect);});
  ...
  if(s.allShield){
    const targets=alive(state),amounts={};for(const p of targets){amounts[p.id]=Math.min(s.allShield,60-p.shield);p.shield+=amounts[p.id];}
  ...
  if(s.heal){
    const target=s.self?h:[...alive(state)].sort((a,b)=>a.hp/a.maxHp-b.hp/b.maxHp)[0],amount=healHero(state,target,s.heal),amounts={[target.id]:amount};
    ...
    events.push({type:'heal',actor:id,targets:s.self?[id]:alive(state).map(p=>p.id),amount,amounts,style:s.style,label:s.name});log(state,`${s.name}：${target.short}回复 ${amount} 生命${s.allHeal?`，其余队员回复 ${s.allHeal}`:''}${s.cleanse?`，净化 ${s.cleanse} 层共鸣`:''}。`,'good');
  }
  if(s.shift||s.resetBalance)harmony(state,h,before,events);
  if(s.captainFinish)leaveCaptain(state,h);
  return{ok:true,events};
}
function leaveCaptain(state,h){h.youmuForm='doctor';h.captainTurns=0;h.exhaustedTurns=2;h.exhaustionFresh=true;log(state,'游墓退去。游木虚脱两轮：输出 −20%、承伤 +20%；仍可治疗、用药与行动。','warning');}
...
function scaled(state,n){return Math.round(n*DIFFICULTIES[state.difficulty].damage*(state.boss.weakened?.8:1));}
...
function responseProfile(state,id){
  ...
  Object.assign(p,{special:'',mirror:0,spores:0,charge:0,seals:0,cleanse:0,noSeed:false,keepResource:false,healFactor:1});
  if(id==='parry'){
...
export function responseOptions(state){
  const h=heroOf(state,state.selected)||state.heroes[0],inactive=state.boss.core||state.boss.broken;
  return ['parry','evade','counter'].map(id=>{
    ...
    const damage=Math.round(spec.damage*DIFFICULTIES[state.difficulty].damage*(state.boss.weakened?.8:1)*p.factor)*(spec.hits||1);
    let reward=id==='parry'?`削韧 ${p.stagger}`:id==='evade'?`${h.short}${h.id==='ric'?'向 0 调和最多 '+p.resource+' 点':h.resourceName+' +'+p.resource}`:`${p.damage} 基础${['ric','haart','patch'].includes(h.id)?'魔法':'物理'}反击伤害，削韧 ${p.stagger}`;
    if(id==='counter'&&h.id==='knibbs'&&h.intuition>=3)reward+='；满直感再强化 40% / 12 削韧';if(p.special)reward+='；'+p.special;
    return{id,name:names[id][0],icon:names[id][1],ap:1,description:inactive?'当前无敌方主招；已准备的应对取消，下轮正常恢复 6 行动点':`${spec.group?'群体主招':'单体主招'}减伤 ${Math.round((1-p.factor)*100)}%${spec.damage?`，${spec.group?'每人':'受击者'}预计承伤 ${damage}（护盾 / 防御前）`:'；本次主招无直接伤害'}`,reward};
  });
}
export function prepareResponse(state,id,actorId=state.selected){
  const h=heroOf(state,actorId),error=state.mode!=='playing'?'战斗已结束':!['parry','evade','counter'].includes(id)?'未知的战术应对':!h||h.hp<=0?'请选择存活队员':state.boss.core?'核心阶段无需准备应对':state.boss.broken?'敌人已被打断，本轮无需新增应对':!state.response&&state.ap<1?'行动点不足':'';
  ...
  const name={parry:'招架',evade:'回避',counter:'迎击'}[id];log(state,`${h.short}准备${name}：应对下一次敌方主招，同轮可免费更改。敌招被打断则取消应对，下轮正常恢复 6 行动点。`,'good');
...
function hurtParty(state,events,ids,base,kind,label,style='quake',resonance=true,responseFactor=1){
  let total=0;const amounts={},targets=ids.filter(id=>heroOf(state,id)?.hp>0),reflections=[];
  for(const id of targets){
    const h=heroOf(state,id);let n=Math.round(base*DIFFICULTIES[state.difficulty].damage*(state.boss.weakened?.8:1)*(h.guard?.45:1)*responseFactor*(h.youmuForm==='captain'?.65:1)*(h.exhaustedTurns>0?1.2:1));
    const oldShield=h.shield,shield=Math.min(n,h.shield);h.shield-=shield;n-=shield;const actual=Math.min(h.hp,n);h.hp-=actual;total+=actual;amounts[id]=actual;
    if(h.id==='patch'&&h.hp>0&&base>0){
      if(h.patchForm==='record'&&!h.patchRecorded){h.records=Math.min(6,h.records+1);h.patchRecorded=true;}
      if(h.patchRetaliation&&oldShield>0&&h.shield===0){h.patchRetaliation=false;h.resource=Math.min(10,h.resource+2);reflections.push(h.id);}
    }
  ...
  events.push({type:'boss',actor:'boss',targets,kind,style,amount:total/Math.max(1,targets.length),amounts,label});
...
export function intentInfo(state){
  const b=state.boss;
  if(b.finale)return{name:'停机过载 · 最后放电',desc:`全队承受 ${scaled(state,65)} 魔法伤害 · 物理 ${b.finalePhysical}/1、魔法 ${b.finaleMagic}/1、${state.response?'应对已准备':'还需准备任一应对'} · 双系接入后守住最后放电即可关闭核心 · 剩余 ${b.finaleTurns} 个完整回合，超时恢复 22% 生命`,icon:'crystal',danger:true,responses:responseOptions(state)};
  if(b.core)return{name:'核心重组',desc:`剩余 ${b.coreTurns} 个完整回合 · 需要物理与魔法各 3 次`,icon:'crystal',danger:true,responses:responseOptions(state)};
  if(b.broken)return{name:'架势崩溃',desc:'本轮停止行动 · 受到伤害 +50% · 下一轮抗控',icon:'break',good:true,responses:responseOptions(state)};
  const spec=attackSpec(state),target=heroOf(state,b.intentTarget)?.short||'队员',base=scaled(state,spec.damage),hits=spec.hits||1;
  ...
  if(canInterrupt(state))desc+=' · 可用禁行或破韧打断';if(b.controlImmune)desc+=' · 本轮抗控，无法打断';
  ...
  return{name:b.charging?'地裂 · 蓄力中':spec.name,desc,icon,danger:b.charging||['bloom','pierce','storm','sever','zero_pulse'].includes(spec.key),responses:responseOptions(state)};
}
function applyResponseReward(state,events,response,profile){
  ...
  if(profile.resource){const before=h.resource;h.resource=h.id==='ric'?(Math.sign(before)*Math.max(0,Math.abs(before)-profile.resource)||0):Math.min(h.maxResource,h.resource+profile.resource);harmony(state,h,before,events);log(state,`${h.short}回避成功：${h.resourceName} ${before} → ${h.resource}。`,'good');}
  if(profile.damage){
...
export function endRound(state){
  if(state.mode!=='playing')return{ok:false,error:'战斗已结束',events:[]};
  const b=state.boss,events=[],response=state.response,cancelledResponse=!!response&&(b.core||b.broken),wasBroken=b.broken,wasCore=b.core,wasFinale=b.finale;state.stats.turns++;state.serial++;
  if(b.core){
    if(b.coreFresh){b.coreFresh=false;log(state,'核心稳定显形。接下来有 2 个完整回合完成双系净化。','warning');}
    else{b.coreTurns--;if(b.coreTurns<=0){
      b.core=false;b.coreFresh=false;b.reforms++;b.hp=Math.round(b.maxHp*.28);b.stagger=Math.round(b.maxStagger*.65);b.stage=3;b.broken=false;b.exposed=false;b.charging=false;b.phasePending=false;b.fog=0;b.corePhysical=0;b.coreMagic=0;
      events.push({type:'phase',actor:'boss',targets:['boss'],label:'元素重组'});log(state,'核心重新凝结出躯壳！巨人恢复 28% 生命，击碎后仍可再次净化。','warning');
    }else log(state,`核心正在重组！还剩 ${b.coreTurns} 个回合。`,'warning');}
  }else if(b.broken)log(state,`${bossName(state)}重新稳住架势，错过本轮行动。`,'good');
  else{
    const spec=attackSpec(state),profile=response?responseProfile(state,response.id):null,ids=alive(state).map(h=>h.id),target=alive(state).find(h=>h.id===b.intentTarget)?.id||ids[0],healFactor=profile?.healFactor??1,sporesBefore=b.spores,followupStage=b.stage;
    ...
    if(state.mode==='playing'){
      ...
      if(state.mode==='playing'&&spec.key==='zero_end'&&b.finale){
        if(response&&b.finalePhysical&&b.finaleMagic){
          state.mode='victory';b.finaleFresh=false;state.response=null;
          events.push({type:'victory',actor:'boss',targets:['boss'],label:'核心关闭'});log(state,'双系接入完成，最后一道电流被挡住。核心终于停止运转，维修组的撤离通道重新打开了。','good');
        }else{
          if(b.finaleFresh)b.finaleFresh=false;else b.finaleTurns--;
          if(b.finaleTurns<=0){
            b.finale=false;b.finaleFresh=false;b.finaleTurns=2;b.finalePhysical=0;b.finaleMagic=0;b.hp=Math.round(b.maxHp*.22);b.seals=3;b.sync=0;b.lastKind=null;b.stagger=Math.round(b.maxStagger*.65);b.reforms++;
            events.push({type:'phase',actor:'boss',targets:['boss'],label:'停机失败 · 再启动'});log(state,'未能在期限内完成接入与防护。核心恢复 22% 生命；再次击破后可以重新尝试停机。','warning');
          }else log(state,`终幕尚未结束：物理 ${b.finalePhysical}/1、魔法 ${b.finaleMagic}/1，还需在准备应对后结束回合。`,'warning');
        }
      }
  ...
  state.round++;state.maxAp=6;state.ap=state.maxAp;
  if(cancelledResponse)log(state,'敌方主招未出手，预备应对已取消；本轮正常恢复 6 行动点。','good');
  ...
  const responseBreak=b.broken&&!wasBroken;
  b.exposed=responseBreak;b.controlImmune=(wasBroken||responseBreak)?1:Math.max(0,b.controlImmune-1);
  b.broken=false;b.stagger=Math.min(b.maxStagger,b.stagger<=0?b.maxStagger:b.stagger+12);b.marked=false;
  ...
  if(!wasBroken&&!wasCore)b.weakened=0;
