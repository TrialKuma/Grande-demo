...
export function gmToolsView(profile){
  ...
  const enabled=profile.gmAllHeroes===true,bossEnabled=profile.gmAllBosses===true;
  return `<div class="modal-eyebrow">试玩工具</div><h2>GM · 试玩开关</h2>
    <p class="modal-lead">角色与 BOSS 分别开放，可以独立开启或关闭。</p>
    <h3 class="gm-section-heading">角色全开</h3>
